...
static TABLE* innobase_acquire_mdl(THD* thd, dict_table_t* table)
{
...
for purge thread */
static TABLE* innobase_find_mysql_table_for_vc(THD* thd, dict_table_t* table)
{
	...
	if (purge_thread) {
		...
		return innobase_acquire_mdl(thd, table);
